            ...
            while (! this.locallyEnded) {
                try {
                    ...
                    if (! this.locallyEnded) {
                        ...
                        Writer writer = new BufferedWriter (new OutputStreamWriter (new FileOutputStream (String.format ("/mnt/gaia/pictwourd/stashed/index.manifest/%d.json", tmp.getFileNameId ()))));
